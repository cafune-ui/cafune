...
function (_Component) {
  ...
  function LazyLoad() {
    ...
    _defineProperty(_assertThisInitialized(_this), "lazyLoadIns", void 0);

    _defineProperty(_assertThisInitialized(_this), "imgs", []);
    ...
    _defineProperty(_assertThisInitialized(_this), "lazyContainer", (0, _preact.createRef)());
  ...
  _createClass(LazyLoad, [{
    ...
    key: "updateImgs",
    value: function updateImgs() {
      this.imgs = this.container.querySelectorAll(".".concat(this.props.imgClass));
      this.updateLazy();
    }
  }, {
    ...
    value: function updateLazy() {
      this.imgs.forEach(function (ele) {
        if ((0, _browser.inViewPort)(ele) && !ele.isLoaded && ele.tagName.toLowerCase() === 'img') {
          ele.isLoaded = true;
