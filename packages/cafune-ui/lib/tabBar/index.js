...
function (_Component) {
  ...
  function TabBar() {
    ...
    _defineProperty(_assertThisInitialized(_this), "currentActive", _this.props.activedId);

    _defineProperty(_assertThisInitialized(_this), "onChange", function (activedId) {
  ...
  _createClass(TabBar, [{
    ...
    value: function componentDidMount() {
      (0, _isomorphic.setPadding)("".concat(this.base.getBoundingClientRect().height, "px"));
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      (0, _isomorphic.setPadding)('');
    }
  }, {
    key: "getChildContext",
    ...
    value: function render(_ref) {
      ...
      var cx = (0, _classnames["default"])(_style["default"].tabbar, _defineProperty({}, _style["default"].tabbar__fixed, fixed));
...
_defineProperty(TabBar, "TabBarItem", _item["default"]);
